...
def main():
    input_file_path = 'C:/Workshop_Problem/MilestoneInputs/Input/Milestone2a.json'
    output_file_path = 'C:/Workshop_Problem/Milestones_output/Output_2a.json'
    ...
    while str_list:
        for s in str_list[:]:
            ...
            if w[w_need] <= i and machine_available_time[assigned_machine] <= i:
                ...
                # Cooldown
                if not (100 <= machine_parameters[assigned_machine] <= 200):
